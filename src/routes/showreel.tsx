      ...
      <Section tone="noir" space="lg">
        <Reveal className="relative overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-4 px-6 text-center">
            <p className="meta text-paper/70">Reel 2026</p>
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-12 md:gap-8">
          <div className="md:col-span-6">
            <p className="lede text-paper/70">
              A selected showreel is being edited. No reel has been published yet, so nothing is
              linked here — individual scenes and self-tapes can be shared directly on request.
            </p>
          </div>
          <div className="md:col-span-5 md:col-start-8">
            <p className="meta text-paper/45">Available on request</p>
            <ul className="mt-6 text-paper/75">
              <li className="border-t border-paper/12 py-3">Scene excerpts</li>
              <li className="border-t border-paper/12 py-3">Self-tape for a specific role</li>
              <li className="border-t border-paper/12 py-3">Stage recordings, where available</li>
            </ul>
